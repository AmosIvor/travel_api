...
namespace travel_api.Migrations
{
    ...
    [Migration("20240628142151_AddForeignKeyRoomDetailVsUser")]
    partial class AddForeignKeyRoomDetailVsUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("travel_api.Models.EF.PlanDetail", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PlanDetailId"), 1L, 1);

                    b.Property<int>("LocationId")
                        .HasColumnType("int");

                    b.Property<string>("PlanDetailDescription")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("travel_api.Models.EF.TravelPlan", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TravelPlanId"), 1L, 1);

                    b.Property<DateTime>("PlanCreateAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("TravelPlanName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TravelUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("travel_api.Models.EF.Message", b =>
                {
                    b.HasOne("travel_api.Models.EF.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
